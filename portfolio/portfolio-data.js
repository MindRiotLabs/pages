...
export const PORTFOLIO_PROJECTS = [
  ...
  },
  {
    id: 21,
    name: "IllumiU",
    category: "EdTech / College Admissions",
    status: "Active Build",
    statusClass: "s-build",
    statusSymbol: "◑ ACTIVE BUILD",
    speed: 3,
    ...
    url: null,
    tagline:
      "A student-owned admissions command center that replaces scattered spreadsheets with a clear path from exploration to decision.",
    directionalPotential: "$200K–$1.5M ARR",
    timeToMilestone: "3–6 Months",
    gtmComplexity: "Medium",
    owenAlignment: "Proof of Concept",
    overview:
      "A student-centric college admissions command center built for high-school juniors and seniors. Organized around the brand premise 'Light your path, own your journey', IllumiU replaces chaotic family spreadsheets with a structured admissions CRM tracking institutions, deadlines, supplemental essay clustermaps, and milestone decisions while preserving student ownership.",
    differentiation:
      "Features a 'Reverse Application CRM' with clear progression stages (Considering, Drafting Supplementals, Dispatched, Submitted, Decided) and an intelligent essay topic clustermap to maximize writing reuse. Provides secondary visibility for parents and counselors without disempowering the student.",
    launchInvestment:
      "$10K–$25K (student-facing MVP completion, privacy verification, counselor beta testing).",
    nextSteps: [
      "Complete student-facing MVP interface and essay cluster mapping tool",
      "Validate user experience with test cohorts of high-school seniors, parents, and counselors",
      "Ensure comprehensive compliance with student privacy regulations and data handling standards",
      "Evaluate direct-to-family subscription packaging vs. high-school counseling site licensing",
      "Conduct beta trials during the upcoming fall admissions cycle",
    ],
  },
  {
    id: 22,
